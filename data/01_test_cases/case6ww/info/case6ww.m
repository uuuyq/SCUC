...
mpc.baseMVA = 100;
// bus_i：节点编号
// type：节点类型（1：发电节点，2：负荷节点，3：平衡节点）
// Pd、Qd：节点的有功和无功负荷
// Gs、Bs：节点的导纳（通常为零）
// Vm、Va：节点电压幅值和相角
// baseKV：节点的基准电压
// zone、Vmax、Vmin：区域、最大和最小电压限制
%% bus data
...
// bus：连接的节点编号
// Pg、Qg：发电机的有功和无功功率输出
// Qmax、Qmin：发电机的无功功率限制
// Vg：发电机电压设定
// Pmax、Pmin：发电机的有功功率输出限制
// 其他参数包括启动、停机成本及功率曲线的参数
%% generator data                                    9         10
...
// mpc.branch 包含支路（输电线）的信息：
// fbus、tbus：起始和终止节点编号
// r、x、b：支路的阻抗和导纳
// rateA、rateB、rateC：支路的容量限制
// status：支路状态（1 表示正常，0 表示关闭）
// angmin、angmax：相角限制。
%% branch data
