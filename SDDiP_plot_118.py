...
def running(sample_index, log_file, train_data_path):
    ...
    scenario_dir = os.path.join(train_data_path, "scenarios", f"1_scenario_118.csv")
    ...
    try:
        algo.run_sddip_statistical(f"{sample_index}_118", n_samples_statistical=100)
...
def main(train_data_path):
    ...
    for sample_index in index_list:
        log_file = os.path.join(train_data_path, "log", f"scenario_data.txt")
...
if __name__ == "__main__":
    train_data_path = r"D:\tools\workspace_pycharm\sddip-SCUC-6-24\sddip_result"
