...
class Parameters:
    def __init__(
        ...
        scenario_data_dir = os.path.join(
            TEST_CASES_DIR, test_case_name, scenario_str
        )
        ...
        if scenario_df is None:
            #scenario_df从指定的scenario_dir中读取
            self.scenario_df = pd.read_csv(scenario_dir, sep='\t')
        else:
        ...
        # Stochastic problem 04_scenarios
        self.n_stages = None
    ...
    def initialize(self):
        """Triggers the initialization of all 04_scenarios based on the corresponding data frames"""
        self._calc_ptdf()
    ...
    def _init_deterministic_parameters(self):
        """Initializes all deterministic 04_scenarios"""
    ...
    def _init_stochastic_parameters(self):
        """Initializes all stochastic 04_scenarios"""
